...
- Added local text capture, clipboard parsing, image import, default Apple Vision OCR with optional cloud OCR, cloud LLM extraction with local rule fallback, review editing, dynamic fields, planning validation, built-in calendar events, and local notification scheduling.
